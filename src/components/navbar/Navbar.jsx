...
const Navbar = () => {
  ...
  const renderMobileMenu = (
    ...
    >
      <Link className={classes.categoriaMobile} to="/categories/notebooks">
        <MenuItem>Notebooks</MenuItem>
      </Link>
      <Link className={classes.categoriaMobile} to="/categories/audio">
        <MenuItem>Audio</MenuItem>
      </Link>
      <Link className={classes.categoriaMobile} to="/categories/smartwatches">
      ...
      <AppBar position="static" className={classes.appBar}>
        <Toolbar>
          ...
          <div className={classes.sectionDesktop}>
            ...
            <Link className={classes.categoria} to="/categories/notebooks">
              <MenuItem>Notebooks</MenuItem>
            </Link>
            <Link className={classes.categoria} to="/categories/audio">
              <MenuItem>Audio</MenuItem>
            </Link>
            <Link className={classes.categoria} to="/categories/smartwatches">
              <MenuItem>Smartwatches</MenuItem>
            </Link>
          </div>
